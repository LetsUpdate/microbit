...
public class AccelerometerSettingsActivity extends AppCompatActivity {

    public static final int START_ACCELEROMETER_SETTINGS = 1;
    private TextView current_font_size;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_accelerometer_settings);
        ...
        switch (Settings.getInstance().getAccelerometer_period()) {
            case 1:
                ap1.setChecked(true);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.d(Constants.TAG, "AccelerometerSettingsActivity onOptionsItemSelected");
