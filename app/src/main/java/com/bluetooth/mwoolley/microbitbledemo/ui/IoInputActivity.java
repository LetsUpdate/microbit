        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case BleAdapterService.GATT_CHARACTERISTIC_WRITTEN:
                    ...
                    Log.d(Constants.TAG, "characteristic " + characteristic_uuid + " of service " + service_uuid + " written OK:0x" + Utility.byteArrayAsHexString(b));
...
//                            }
                ...
                case BleAdapterService.GATT_CHARACTERISTIC_READ:
                    ...
                    characteristic_uuid = bundle.getString(BleAdapterService.PARCEL_CHARACTERISTIC_UUID);
                    b = bundle.getByteArray(BleAdapterService.PARCEL_VALUE);
                    Log.d(Constants.TAG, "characteristic " + characteristic_uuid + " of service " + service_uuid + " read value: 0x" + Utility.byteArrayAsHexString(b));
                ...
                case BleAdapterService.GATT_DESCRIPTOR_WRITTEN:
                    ...
                    b = bundle.getByteArray(BleAdapterService.PARCEL_VALUE);
                    Log.d(Constants.TAG, "descriptor " + descriptor_uuid + " of characteristic " + characteristic_uuid + " of service " + service_uuid + " written OK:0x" + Utility.byteArrayAsHexString(b));
